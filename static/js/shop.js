            ...
            computed: {
                filteredOrders() {
                    ...
                    if (this.orderStatusFilter !== 'all') {
                        sortedOrders = sortedOrders.filter(order => order.status === this.orderStatusFilter);
                    }
                    ...
                    if (this.menuItemFilter) {
                        sortedOrders = sortedOrders.filter(order => 
                            order.items && order.items.some(item => 
                                item.menu_item && item.menu_item.id === this.menuItemFilter
                            )
                        );
                    }
                    ...
                    if (this.communityFilter) {
                        console.log('communityFilter:', this.communityFilter, typeof this.communityFilter);
                        console.log('sortedOrders:', sortedOrders);


                        sortedOrders = sortedOrders.filter(order => 
                            order.building && 
                            order.building.community_id === parseInt(this.communityFilter)
                        );
                    }
